...
function Tweet(props) {
  ...
  function handleTweetLike(tweetid) {
    ...
    var imagepath =
      document.getElementsByClassName("tweetLike")[id].style.color;
    if (imagepath === "white") {
      document.getElementsByClassName("tweetLike")[id].style.color = "green";
      document.getElementsByClassName("likeIcon")[id].src = greenLike;
  ...
  function handleTweetBookmark(e, tweetid) {
    ...
    if (markBM) {
      ...
      if (responseBM === "Unsaved") {
        document.getElementsByClassName("bookmarkIcon")[id].src =
          greenBookmarks;
      }
    }
  }
  ...
  function handleRetweet(tweetid, name, image, video, text) {
    ...
    setOPacity();
    var retweetPath =
      document.getElementsByClassName("tweetRetweet")[id].style.color;
  ...
  /* HASHTAGS */
  const { loading, tagTweets, getTag } = useSelector(
    (ta) => ta.TagTweetFeedReducer
  );
  ...
  return (
    <>
      {retweets == null ? (
        <div className="tweetComp POPUPBG">
          ...
          >
            ...
            <div className="USERNAME">
              ...
              <p
                className="tweetUsername2"
                onMouseOver={showProfilePopup}
        ...
        <div className="tweetComp POPUPBG" id="tweetRet">
          <div
            className="firstTweetBlock"
            onClick={() => {
              handleToTweet(props.tweetId);
          ...
          <div className="tweetWithRetwwet">
            ...
            <p className="TWRText">
              <ReactHashtag
                renderHashtag={(val) => (
                  <span onClick={() => showTagTweet(val)}>{val}</span>
                )}
