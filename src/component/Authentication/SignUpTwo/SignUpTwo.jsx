...
setCheckPass(true)
  ...
  const {loading, error, response} = signUp;
  useEffect(()=>{
    if(loading===true){
...
const navigate=useNavigate();
    ...
    <button type="button" className='authSignIn' id="signTwoBtn" onClick={()=>{dispatch(SignUpTwoUser(data),console.log("vhb"))}}>Sign Up</button>
    </div>
